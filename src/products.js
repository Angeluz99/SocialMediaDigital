...
const Products = () => {
  ...
  const productsData = [
    ...
    { icon: 'fa-thermometer', title: 'Fibroblastos', presentaciones: "1000uds 2000uds 3000uds 4000uds", description: 'Los fibroblastos son las principales células productoras de colágeno y elastina en nuestro cuerpo. Son esenciales en el rejuvenecimiento de la piel.', imageUrl: '/images/product3.jpg' },
    ...
    { icon: 'fa-viruses', title: 'NK', presentaciones: "1000uds 2000uds 3000uds", description: 'Las células asesinas naturales (natural killer cells [NK]) son un tipo de linfocitos producidos en la médula ósea, cuya función efectora está mediada por la producción de citocinas y su actividad citotóxica.', imageUrl: '/images/product6.jpg' },
    ...
    { icon: 'fa-seedling', title: 'Extracto Proteico', presentaciones: "1000uds 2000uds 2000uds 3000uds", description: 'Combina más de 300 factores de crecimiento específicos, seleccionados y purificados secretados por células madre, colágeno y antioxidantes para estimular la reparación y revitalización de la piel y el cabello.', imageUrl: '/images/product8.jpg' },
    { icon: 'fa-fire-flame-curved', title: 'Implantes de Placenta', presentaciones: "10mgs 20mgs ", description: 'El implante liofilizado es un biológico a base de placenta; esta es sometida a varios procedimientos físicos y químicos, los cuales aseguran preservar todas sus cualidades químicas encargadas de desencadenar la gran cantidad de cambios físicos en el cuerpo en busca de una homeostasis corporal', imageUrl: '/images/product9.jpg' },
    { icon: 'fa-flask', title: 'Mixture', presentaciones: "1000uds 2000uds 3000uds", description: 'Mixture combina las terapias más novedosas de la medicina regenerativa lo que lo convierte en el producto más completo de la industria estética. ', imageUrl: '/images/product10.jpg' },
    { icon: 'fa-tablets', title: 'Pellet', presentaciones: "10mg 200mg 30mg", description: 'La hormona bioidentica, también conocida como “pellet”, es una pieza pequeña del tamaño de un grano de arroz, que consiste de polvo comprimido compuesto por hormonas naturales bioidénticas como estrógeno y testosterona', imageUrl: '/images/product11.jpg' },
    { icon: 'fa-face-kiss-wink-heart', title: 'Suero Facial', presentaciones: "10mg 200mg 30mg", description: 'Serum facial de ácido hialurónico, vitamina C, complex MAP, para cuello, cara y escote', imageUrl: '/images/product12.jpg' },
