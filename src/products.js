...
const Products = () => {
  ...
  const productsData = [
    ...
    { title: 'Exosomas', presentaciones: "1000uds 2000uds 3000uds", description: '4 los Exosomas son pequeñas vesículas, que provienen de las células, con un alto contenido en proteínas, lípidos, ARN mensajero, ARN mitocondrial, ADN y distintos factores de crecimiento.', imageUrl: '/images/productsImages/product4.jpg' },
    { title: 'Factor de Transferencia', presentaciones: "1000uds 2000uds 3000uds", description: '5 El Factor de Transferencia es un producto que consta de moléculas mensajeras que llevan información al sistema inmunológico de un individuo (Inmunomodulador) para incrementar sus defensas y su función.', imageUrl: '/images/productsImages/product5.jpg' },
    { title: 'NK', presentaciones: "1000uds 2000uds 3000uds", description: '6 Las células asesinas naturales (natural killer cells [NK]) son un tipo de linfocitos producidos en la médula ósea, cuya función efectora está mediada por la producción de citocinas y su actividad citotóxica.', imageUrl: '/images/productsImages/product6.jpg' },
    { title: 'Factores de Crecimiento', presentaciones: "1000uds 2000uds 3000uds", description: '7 Los factores de crecimiento plasmático son proteínas que se encuentran en los tejidos y se encargan de la reparación de tejido dañado, en enfermedades como tendinopatías, lesiones meniscales o úlceras corneales y vasculares, o alopecia, entre otras', imageUrl: '/images/productsImages/product7.jpg' },
    { title: 'Sueros', presentaciones: "1000uds 2000uds 3000uds", description: '13 Son diez tipos diferentes de sueros de regeneración acordes a la necesidad de cada paciente (Inmunológico, Osteo-regenerativo, hematopoyético, Regeneración hormonal, Dermo Artro Infeccioso, Anérgico, Energético entre otros)', imageUrl: '/images/productsImages/product13.jpg' },
  ];
